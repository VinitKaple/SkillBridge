...
const COMPANIES = [
  {
    ...
    logo: "🔵",
    tier: "FAANG",
    description: "Focuses on fundamentals, scalability, and problem solving",
  },
  {
    name: "Amazon",
    logo: "🟠",
    tier: "FAANG",
    description: "Leadership principles + STAR method, system design",
  },
  {
    name: "Microsoft",
    logo: "🟦",
    tier: "FAANG",
    description: "Structured interviews, collaborative culture, growth mindset",
  },
  {
    name: "Razorpay",
    logo: "🔷",
    tier: "Unicorn",
    description: "Payments domain, security awareness, real-world scenarios",
  },
  {
    name: "Swiggy",
    logo: "🟧",
    tier: "Unicorn",
    description: "Ops-minded, real-world failures, casual but technical",
  },
  {
    name: "Flipkart",
    logo: "🟡",
    tier: "Unicorn",
    description: "Product thinking, India-scale problems, e-commerce context",
  },
];
