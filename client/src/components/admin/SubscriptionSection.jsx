...
import { CheckCircle, XCircle, Zap, Shield, ArrowUpRight, Target, BarChart3, Star } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="relative rounded-2xl border-2 border-blue-500 bg-white p-5 shadow-lg">
          ...
          <button
            onClick={() => toast.success("Upgrade initiated! Check your email for confirmation.")}
