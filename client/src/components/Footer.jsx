        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center sm:text-left">
          ...
          <div className="flex items-center justify-center sm:justify-start">
            ...
            <div className="ml-3">
              ...
              <span className="text-sm">  VinitKaple / NikhilShukla </span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="ml-3">
              <h4 className="text-white text-lg font-semibold">Contact Support</h4>
  ...
  >
    N
        ...
        <div className="m-auto flex flex-col items-center md:items-start px-6 space-y-4">
          <div>
            ...
            <ul className="text-sm space-y-2">
              <li><a href="/dashboard" className="text-blue-300 hover:underline">Career Support</a></li>
              <li><a href="/analytics" className="text-blue-300 hover:underline">Advertising & Insights</a></li>
                    <li><a href="/analytics" className="text-blue-300 hover:underline">Term & Condition</a></li>
         
            </ul>
          </div>
          <div>
            <h3 className="text-white text-lg font-semibold mb-2">AI fraud Help</h3>
            <ul className="text-sm space-y-1">
              <li>AI Detecter: <a href="tel:1800112211" className="text-blue-300 hover:underline">1800-11-2211</a></li>
              <li>AI Fraud: <a href="tel:155260" className="text-blue-300 hover:underline">155260</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <p className="text-sm leading-relaxed text-gray-300">
           This website was developed for IndiaNext Hackathon.
...
During the development phase, all names, data, references, and scenarios used on this platform are entirely fictional, simulated, or generated by AI for demonstration purposes only. Any resemblance to real individuals, organizations, banks, or entities is purely coincidental and unintended.
      ...
      <div className="bg-white py-4">
        <div className="max-w-7xl mx-auto px-4 flex justify-center items-center text-sm text-black text-center font-medium">
          <p>© {new Date().getFullYear()} SkillBridge – From Skills to Jobs </p>
        </div>
      </div>
    </footer>
  );
